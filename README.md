...
```bash
bash <(curl -Lk https://github.com/kingparks/cursor-vip/releases/download/latest/i.sh) 3035decf91ef46c09e6082bab8fff98c
```
Method 2: Install via Gitee script
```bash
bash <(curl -Lk https://gitee.com/kingparks/cursor-vip/releases/download/latest/ic.sh) 3035decf91ef46c09e6082bab8fff98c
```
...
cursor-vip 3035decf91ef46c09e6082bab8fff98c;
# Windows 
